            ...
            <div ng-repeat="status in statuses" class="form-group">
                ...
                <div class="pagelet" id="pagelet{{status.statusId}}">
                    <div class="pagelet">
                        <div class="row">
                            <div class="col-md-2" >
                                <img fallback-src="<?php echo base_url() . PROFILE_PICTURE_PATH_W40_H40 ?>40x40_{{userGenderId}}.jpg" style="border: 1px solid lightgray" ng-src="<?php echo base_url() . PROFILE_PICTURE_PATH_W40_H40; ?>{{status.userInfo.userId}}.jpg?time= <?php echo time(); ?>" width="40" height="40">
                            </div>
                            <div class="col-md-10" >
                                <div class="row">
                    ...
                    <div class="pagelet">
                        ...
                        <div class="row">
                            <div class="col-md-1" profile_picture>
                                <img  fallback-src="<?php echo base_url() . PROFILE_PICTURE_PATH_W30_H30 ?>30x30_{{userGenderId}}.jpg" alt="" ng-src="<?php echo base_url() . PROFILE_PICTURE_PATH_W30_H30 . $user_id . '.jpg?time=' . time(); ?>" />
                            </div>
                            <div class="col-md-11">
