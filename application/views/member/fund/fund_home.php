<div class="row padding_top_over_row">
    ...
    <div class="col-md-offset-1 col-md-2">
        <a  href="<?php echo base_url(); ?>fund/course_add"><button class="btn btn-xs" style="background-color: #703684; color: white; font-weight: bold; padding: 3px 20px;">Start a Campaign</button></a>
    </div>
