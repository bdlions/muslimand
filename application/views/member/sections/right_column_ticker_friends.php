...
<div style="height: 50%; overflow-x:hidden; overflow-y: scroll">
    <div class="row">
        <div class="col-md-12">
            <div class="ticker_friends message_friends_divider_others" onclick="open_message_window_1()">
                <div class="row">
                    <div class="col-md-3">
                        <img src="<?php echo base_url(); ?>resources/images/user_data/profile_pictures/profile_pictures_8.jpg"  width="30" height="30">
                    </div>
...
<div style="position: absolute; right: 100%; bottom: 0; width: 360%; font-size: 10px;">
    <div class="row" style="position: relative; bottom: 0px; margin: 5px;">
        <div class="col-md-4">
            <div id="msg_window_1" class="msg" style="display: none;">
                ...
                <div class="textarea_background_style">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="col-md-12"><textarea class="chatting_textarea_style" rows="1"></textarea></div>
                        </div>
                        <div class="col-md-2">
        ...
        <div class="col-md-4">
            <div id="msg_window_3" class="msg" style="display: none;">
                <div class="message_friends_divider_full">
                    <div class="row">
                        <div class="col-md-2">
                            <img class="img-responsive" style="margin-top: 3px;" src="<?php echo base_url() ?>resources/images/online.png">
