    ...
    <div class="col-md-10">
        ...
        <div id="chat_box_container" class="message_friends_divider_others" style="height: 150px; width: 100%; overflow-y: scroll; overflow-x: hidden; background-color: #fff;">
            <div class="row">
                <div class="col-md-12">
                    <div class="message_owner_style pull-right">
                        <span class="message_owner_content_style">Hi, Fatema!!! How are you? Myself Azhar.</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="message_owner_style pull-right">
                        <span class="message_owner_content_style">Hello. I'm OK. What about you?</span>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="message_friend_style pull-left">
                        <span class="message_friend_content_style">Yes. EEE in XYZ University. What are you doing?</span>
                    </div>
                </div>
            </div>
            <div class="row">
