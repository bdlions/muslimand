            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="message_owner_style pull-right">
                        <span class="message_owner_content_style">Hi, Obama!!! How are you? Myself Azhar.</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="message_owner_style pull-right">
                        <span class="message_owner_content_style">Hello. I'm fine. Thanks. How are you?</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="message_friend_style pull-left">
                        <span class="message_friend_content_style">Going well. Tell me about yourself.</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="message_friend_style pull-left">
                        <span class="message_friend_content_style">I'm president of USA. And you?</span>
                    </div>
                </div>
            </div>
            <div class="row">
