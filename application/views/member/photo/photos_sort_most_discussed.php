...
<div class="row">
    ...
    <div class="col-md-2">
        <a  href="<?php echo base_url(); ?>photos/photos_add"><button class="btn btn-xs" style="background-color: #703684; color: white; font-weight: bold; padding: 3px 28px;;">Upload a New Image</button></a>    </div>
    ...
    <div class="col-md-9">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <?php $this->load->view("member/pagelets/photo/sort_most_discussed"); ?>
            </div>
            <div class="col-md-3">
        </div>
    </div>
