        ...
        <div class="row">
            <div class="col-md-12">
                <div class="border_style slider_body">
                    ...
                    <div class="flipbook">
                        <div class="slide">
                            <img src="<?php echo base_url(); ?>resources/images/user_data/profile_pictures/1.jpg" alt="" /> 
                            <!--<div class="content"><a href="#">Flowers: What you didn't know</a></div>--> 
                        </div>
                        <div class="slide">
                            <img src="<?php echo base_url(); ?>resources/images/user_data/profile_pictures/2.jpg" alt="" /> 
                            <!--<div class="content"><a href="#">Flowers: Real or Fiction?</a></div>--> 
                        </div>
                        <div class="slide">
                            <img src="<?php echo base_url(); ?>resources/images/user_data/profile_pictures/3.jpg" alt="" /> 
                            <!--<div class="content"><a href="#">A Flower ate my Baby!</a></div>--> 
                        </div>
                        <div class="slide">
                            <img src="<?php echo base_url(); ?>resources/images/user_data/profile_pictures/4.jpg" alt="" /> 
