    ...
    <div style="margin-bottom: 3px;">
        ...
        <div class="row form-group padding_top_10px">
            <div class="col-md-3" ng-repeat="photo in albumPhotoList" style="padding-bottom: 28px;">
                <img style="border: 1px solid #703684; height: 120px; width: 150px;"   ng-click="openPhotoModal(photo, albumDetail.userInfo)" src="<?php echo base_url() . USER_ALBUM_IMAGE_PATH ?>{{photo.image}}">
            </div>
        </div>
        <!--        <div class="row form-group">
                    <div class="col-md-4">
        ...
        <div class="pagelet pagelet_mg_custom">
            ...
            <span ng-if='albumDetail.shareCounter > 0'>
             ...
             <div class="row form-group" ng-if="albumDetail.commentCounter > 0">
