                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="modal_photo_pagelet">
                            <div class="row">
                                <div class="col-md-2">
                                    <img class="img-responsive" ng-src="http://localhost/muslimand/resources/images/profile_picture/40x40/Rx9hPNdqmRLRb4i.jpg?time= 1457357330" style="border: 1px solid lightgray" fallback-src="http://localhost/muslimand/resources/images/profile_picture/40x40/40x40_1.jpg" src="http://localhost/muslimand/resources/images/profile_picture/40x40/Rx9hPNdqmRLRb4i.jpg?time= 1457357330">
                                </div>
                                <div class="col-md-10">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div style="float: left;">
                                                        <!--<a style="font-weight: bold;" href="http://localhost/muslimand/member/timeline/Rx9hPNdqmRLRb4i"><span ng-bind="status.userInfo.firstName" class="ng-binding">Alamgir</span>&nbsp;<span ng-bind="status.userInfo.lastName" class="ng-binding">Kabir</span></a>--> 
                                                        <a style="font-weight: bold;" href="http://localhost/muslimand/member/timeline/Rx9hPNdqmRLRb4i"><span class="ng-binding">Alamgir</span>&nbsp;<span class="ng-binding">Kabir</span></a> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <ul style="list-style-type: none; padding: 0;">
                                                        <li class="dropdown">
                                                            <img width="15" height="15" ng-src="http://localhost/muslimand/resources/images/friends_icon.png" src="http://localhost/muslimand/resources/images/friends_icon.png">
                                        ...
                                        <!-- ngIf: 3 == status.statusTypeId --><div ng-if="3 == status.statusTypeId" class="ng-scope">
                                            <div class="row from-group">
                                                <div class="col-md-12 form-group">
                                                    <img ng-src="http://localhost/muslimand/resources/images/photos/albums/user_album/Rx9hPNdqmRLRb4i_1454386530.jpg" style="border: 1px solid #703684; float: left;" class="img-responsive" src="http://localhost/muslimand/resources/images/photos/albums/user_album/Rx9hPNdqmRLRb4i_1454386530.jpg">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <!-- ngIf: status.likeStatus != '1' --><span ng-if="status.likeStatus != '1'" class="ng-scope">
                                                <a ng-click="addLike(status.userInfo.userId, status.statusId)" id="statusLike3SNXd7ulUTAXfrV" href="" style="color: #3B59A9;">
                                                    <img src="http://localhost/muslimand/resources/images/like_icon.png"> Like </a>.
                                            ...
                                            <a onclick="select_comment_field(angular.element(this).scope().status.statusId)" href="" style="color: #3B59A9;">
                                                <img ng-src="http://localhost/muslimand/resources/images/comment_icon.png" src="http://localhost/muslimand/resources/images/comment_icon.png"> Comment </a>.
                                            <a onclick="open_modal_share(angular.element(this).scope().status)" href="" id="share_add_id" style="color: #3B59A9;">
                                                <img ng-src="http://localhost/muslimand/resources/images/share_icon.png" src="http://localhost/muslimand/resources/images/share_icon.png"> Share</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="row">
                                    <div profile_picture="" class="col-md-2">
                                        <img ng-src="http://localhost/muslimand/resources/images/profile_picture/30x30/Rx9hPNdqmRLRb4i.jpg?time=1457357330" fallback-src="http://localhost/muslimand/resources/images/profile_picture/30x30/30x30_1.jpg" src="http://localhost/muslimand/resources/images/profile_picture/30x30/Rx9hPNdqmRLRb4i.jpg?time=1457357330">
                                    </div>
                                    <div class="col-md-10">
