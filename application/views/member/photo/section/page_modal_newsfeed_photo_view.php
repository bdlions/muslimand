<script type="text/ng-template" id="template/page_newsfeed.html">
        ...
        <div class="">
            <carousel>
                <slide ng-repeat="photoInfo in sliderImages" active="photoInfo.active">
                    <img ng-src="<?php echo base_url() . PAGE_IMAGE_PATH ?>{{photoInfo.image}}"  class="img-responsive" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div style="float: left;">
                                                    <a href="<?php echo base_url(); ?>pages/timeline/{{photoInfo.pageInfo.pageId}}" style="font-weight: bold;"><span ng-bind="photoInfo.pageInfo.title"></span></a> 
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div style="float: left;" class="row from-group">
                                    <div class="col-md-12">
                                        ...
                                        <span ng-if = "photoInfo.likeStatus == '1'">
                                            <a href style="color: #3B59A9;" id="page_photo_unlike{{photoInfo.photoId}}">
                                                <img src="<?php echo base_url() ?>resources/images/like_icon.png">
                                                Liked
                                            </a>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span ng-if = "photoInfo.likeCounter > 0">
                                    <img src="<?php echo base_url(); ?>resources/images/like_icon.png">
                                    <a  id="like_list_id"  style="color: #3B59A9;" href onclick="open_modal_page_photo_likelist(angular.element(this).scope().photoInfo.photoId)" >
                                        <span ng-if = "photoInfo.likeStatus === '1'">
...
<script type="text/javascript">
    ...
    function open_modal_page_photo_likelist(photoId) {
        angular.element($('#page_photo_likelist_id')).scope().getPhotoLikeList(photoId, function() {
    ...
    function add_page_photo_like(photoInfo) {
        ...
        if ('<?php echo STATUS_TYPE_ID_PAGE_CHANGE_PROFILE_PICTURE; ?>' == statusTypeId ||
            ...
            angular.element($('#page_photo_like' + photoId)).scope().addPagePhotoLike(photoId, referenceId, function() {
                $("#page_photo_like" + photoId).hide();
                $("#page_photo_unlike" + photoId).show();
            });

        }
        if ('<?php echo STATUS_TYPE_ID_POST_STATUS_BY_ADMIN_AT_PAGE_PROFILE_WITH_M_PHOTOS; ?>' == statusTypeId ||
                '<?php echo STATUS_TYPE_ID_POST_STATUS_BY_MEMBER_AT_PAGE_PROFILE_WITH_M_PHOTOS; ?>' == statusTypeId) {
            angular.element($('#page_photo_like' + photoId)).scope().addPageMPhotoLike(photoId, function() {
                $("#page_photo_like" + photoId).hide();
                $("#page_photo_unlike" + photoId).show();
            });
        }
