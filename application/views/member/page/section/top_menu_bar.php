    ...
    <div class="col-md-12">
        <div style="background-color: whitesmoke; margin-left: -15px;">
            <div aria-label="..." role="group" class="btn-group">
                ...
                <a id="aboutPageMenu" style="font-size: 100%" class="btn btn-default get_over_view_class">About</a>
                <a href="<?php echo base_url(); ?>pages/get_home_photos/{{PageBasicInfo.pageId}}" style="font-size: 100%" class="btn btn-default">Photos</a>
