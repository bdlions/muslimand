<script type="text/ng-template" id="template/slider_photo-modal.html">
    ...
    <div class="row">
    <div class="col-md-2" >
    <img fallback-src="<?php echo base_url() . PAGE_PROFILE_PICTURE_PATH_W40_H40 ?>40x40.jpg" style="border: 1px solid lightgray" ng-src="<?php echo base_url() . PAGE_PROFILE_PICTURE_PATH_W40_H40; ?>{{photoInfo.pageInfo.pageId}}.jpg?>" alt="">
    </div>
    <div class="col-md-10">
    <div class="row">
    ...
    <a style="font-weight: bold;" href="<?php echo base_url(); ?>member/timeline/{{photoInfo.pageInfo.pageId}}">{{photoInfo.pageInfo.title}}</a> 
    </div>
    </div>
    </div>
