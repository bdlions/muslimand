                ...
                <slide ng-repeat="photoInfo in sliderImages" active="photoInfo.active">
                    ...
                    <div class="row" style="bottom: 55px; position: fixed; margin-left: 220px;">
                     ...
                     <div class="modal_photo_pagelet" style="bottom: 70px; float: right; position: fixed; right: 40px; width: 504px; z-index: 99999999;">
                        <div class="row">
                            <div class="col-md-2" >
                                <img fallback-src="<?php echo base_url() . PAGE_PROFILE_PICTURE_PATH_W40_H40 ?>40x40_{{photoInfo.genderId}}.jpg" style="border: 1px solid lightgray" ng-src="<?php echo base_url() . PAGE_PROFILE_PICTURE_PATH_W40_H40; ?>{{photoInfo.pageId}}.jpg?time= <?php echo time(); ?>" alt="">
                            </div>
                            <div class="col-md-10">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div style="float: left;">
                                                    <a style="font-weight: bold;" href="<?php echo base_url(); ?>pages/timeline/{{photoInfo.pageInfo.pageId}}">{{photoInfo.pageInfo.title}}</a> 
                                                </div>
                                            </div>
                                        </div>
