<div ng-repeat="albumDetail in albumDetailList" ng-clock>
    <div class="pagelet" style="margin-bottom: 3px; margin-left: -15px;">
        ...
        <div class="row form-group padding_top_10px">
            <div class="col-md-4" ng-repeat="photo in albumPhotoList" style="padding-bottom: 28px;">
                <!--<a href="<?php // echo base_url();  ?>photos/get_photo/{{photo.photoId}}" >-->

                <div onclick="get_photo_info(angular.element(this).scope().photo.photoId)">
    ...
    <div class="pagelet pagelet_mg_custom" style="margin-left: -15px;">
        <div class="row form-group">
            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function open_modal_album_shared(albumId) {
     ...
     function get_photo_info(photoId){
          $('#modal_page_photo_display_id').modal('show');
     }
    $(function() {
...
<?php $this->load->view("member/page/section/modal_page_photo_view"); ?>
