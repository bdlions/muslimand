...
<div class="row">
    ...
    <div class="col-md-2">
        <a  href="<?php echo base_url(); ?>photos/photos_add"><button class="btn btn-xs" style="background-color: #703684; color: white; font-weight: bold; padding: 3px 28px;">Create a Page</button></a>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="video_ul">
                    ...
                    <a href="<?php echo base_url(); ?>pages/photos_view_my"><li>My Pages</li></a>
                    <a href="<?php echo base_url(); ?>pages/photos_view_friend"><li>Friends’ Pages</li></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="category_ul">
                    ...
                    <div class="category_divider"></div>
                    <a href=""><li>Local Business</li></a>
                    <div class="category_divider"></div>
                    <a href=""><li>Place</li></a>
                    <div class="category_divider"></div>
                    <a href=""><li>Entertainment</li></a>
                    <div class="category_divider"></div>
                    <a href=""><li>Companyn</li></a>
                    <div class="category_divider"></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo base_url(); ?>photos/photos_sort_most_discussed">Most Liked</a></li>
                            </ul>
                        </div>
                        &nbsp;
