                            ...
                            <div id="brand" class="brand">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-10" ng-init="setBrandSubcategoryList('<?php echo htmlspecialchars(json_encode($brand_subcategories)); ?>')" >
                                        <select  class="form-control " ng-options="subCategory.title for subCategory in brandSubCategoryList" ng-model="PageInfo.subCategory">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-10">
                                        ...
                                        <input type="text" class="form-control page_custom_form_control" ng-model="PageInfo.title">
                                    </div>
                                    <div class="col-md-offset-1"></div>
                                </div>
                                <div class="row">
