...
<div class="row">
  ...
  <ul class="pagination pagination_margin">
    ...
    <li><a href="<?php echo base_url(); ?>videos/videos_iframe">1</a></li>
    <li><a href="<?php echo base_url(); ?>videos/videos_iframe">2</a></li>
    <li><a href="<?php echo base_url(); ?>videos/videos_iframe">3</a></li>
    <li><a href="<?php echo base_url(); ?>videos/videos_iframe">4</a></li>
    <li><a href="<?php echo base_url(); ?>videos/videos_iframe">5</a></li>
    <li>
      <a href="<?php echo base_url(); ?>videos/videos_iframe" aria-label="Next">
