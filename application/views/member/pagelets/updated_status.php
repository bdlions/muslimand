    ...
    <div class="pagelet">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-11">
                <div class="row">
                    <div class="col-md-12">
                        <a style="font-weight: bold;" href><span ng-bind="status.comment.status_comment_info.userInfo.fristName"></span>&nbsp<span ng-bind="status.comment.status_comment_info.userInfo.lastName"></span></a>
                        <span ng-bind="status.comment.status_comment_info.description">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
