        ...
        <div class="col-md-4" ng-repeat="friend in friends">
            <div class="friend_list_img_style">
                <a href='<?php echo base_url(); ?>member/timeline/{{friend.userId}}' >
                    <img  alt="" src="<?php echo base_url() . PROFILE_PICTURE_PATH_W25_H25; ?>{{friend.userId}}.jpg" onError="onImageUnavailable(this)"/>
                    <img style="visibility:hidden; height: 0px" src="<?php echo base_url() . PROFILE_PICTURE_PATH_W25_H25; ?>25x25_{{friend.genderId}}.jpg" alt="">
