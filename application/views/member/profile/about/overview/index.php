<div id="about_overview" class="row">
    <div class="col-md-6">
        ...
        <div class="row form-group" ng-click="getWorksEducation('<?php echo $user_id ;?>')">
            <div class="col-md-12">
        ...
        <div class="row form-group" ng-click="getCityTown('<?php echo $user_id ;?>')">
            <div class="col-md-12">
                <div class="cursor_holder_style">
                    <img style="border: 1px solid lightpink;" src="<?php echo base_url(); ?>resources/images/plus.png">
    ...
    <div class="col-md-6">
        ...
        <div class="row form-group" ng-click="getContactBasicInfo('<?php echo $user_id ;?>')">
            <div class="col-md-12">
                <a class="cursor_holder_style">Edit your contact and basic info</a>
            </div>
        </div>
    </div>
</div>
