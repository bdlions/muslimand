<div class="row form-group">
    <div class="col-md-offset-2 col-md-10">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" id="school_add_id" class="form-control" ng-model="school.sch">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-4">
                        <select class="form-control"  ng-options="year for year in yearList" ng-model="school.sd">
                    ...
                    <div class="col-md-4">
                        <select class="form-control"  ng-options="year for year in yearList" ng-model="school.ed">
                            <option value="" selected>Select Year</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <textarea type="text" class="form-control" ng-model="school.desc"></textarea>
            </div>
        </div>
