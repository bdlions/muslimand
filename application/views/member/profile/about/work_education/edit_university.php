<div class="row">
    <div class="col-md-12">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" id="university_add_id" class="form-control" ng-model="university.uni">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="pages_type_add_form_input">
                            <select class="form-control"  ng-options="year for year in yearList" ng-model="university.sd">
                    ...
                    <div class="col-md-5">
                        <div class="pages_type_add_form_input">
                            <select class="form-control"  ng-options="year for year in yearList" ng-model="university.ed">
                                <option value="" selected>Select Year</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <textarea type="text" class="form-control" ng-model="university.desc"></textarea>
            </div>
        </div>
