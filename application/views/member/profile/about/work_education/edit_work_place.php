<div class="row" id="edit_word_place" style="padding: 10px;">
    <div class="col-md-12" >
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control form_control_custom_style" ng-model="workPlace.company">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control form_control_custom_style" ng-model="workPlace.position">
            </div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control form_control_custom_style" ng-model="workPlace.city">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-4">
                ...
                <div class="row" id="add_year">
                    <div class="col-md-5">
                        <div class="pages_type_add_form_input">
                            <select class="form-control form_control_custom_style"  ng-options="year for year in yearList" ng-model="workPlace.startDate">
                    ...
                    <div class="col-md-5">
                        <div class="pages_type_add_form_input">
                            <select class="form-control form_control_custom_style"  ng-options="year for year in yearList" ng-model="workPlace.endDate">
                                <option value="" selected>Select Year</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    function close_work_place(workPlaceId) {
        $("#edit_word_place").hide();
