<div class="col-md-12" >
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" ng-model="workPlace.cmp">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-md-4">
            ...
            <div class="row" id="add_year">
                <div class="col-md-5">
                    <div class="pages_type_add_form_input">
                        <select class="form-control"  ng-options="year for year in yearList" ng-model="workPlace.sd">
                ...
                <div class="col-md-5">
                    <div class="pages_type_add_form_input">
                        <select class="form-control"  ng-options="year for year in yearList" ng-model="workPlace.ed">
                            <option value="" selected>Select Year</option>
                        </select>
                    </div>
                </div>
