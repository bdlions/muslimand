                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-offset-3 col-md-5">
                                <div class="message_friends_box_1 btn-group" role="group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="user_comment">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span>Walaikum As salam, vai. Alhamdulillah, valo achi. Apni kemon achen?</span>
                                            </div>   
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="message_friends_divider_others">
                            ...
                            <div class="message_friends_box_1">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="message_text">
