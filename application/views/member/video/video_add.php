            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" type="text" style="width: 600px;" size="40" value="" ng-model="videoInfo.url"><br>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <button class="btn btn-xs" style=" padding: 3px 28px; background-color: #703684; color: white; font-weight: bold;" ng-click="addVideo()">Add</button>
                    </div>
                    <div class="col-md-8"></div>
                </div>
                <div class="row form-group"></div>
