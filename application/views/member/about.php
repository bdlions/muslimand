                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 border_left"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="main_wrapper" id="top">
            <div class="container-fluid">
                ...
                <div class="row middle">
                    <div class=" col-md-1" style="background-color: #E9EAED; border: 1px solid #DCDCDC;">
                        </br>
                        </br>
                    </div>
                    <div class=" col-md-7" style=" position: relative; border: 1px solid #DCDCDC;">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="font-size: 100%">
                                More
