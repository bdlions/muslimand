<div class="pagelet" style="border: 1px solid lightgray;">
    <div class="row form-group" id="brif_work_id" style="display: none" >
        <div class="col-md-2">
    ...
    <div class="row form-group" id="brif_uv_id" style="display: none">
        <div class="col-md-2">
    ...
    <div class="row form-group" id="brif_city_id" style="display: none">
        <div class="col-md-2">
