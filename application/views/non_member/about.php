            ...
            <div class="col-md-12">
                ...
                <div class="pagelet">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="pagelet">
                                <?php $this->load->view("non_member/about/overview/index"); ?>
                                <?php $this->load->view("non_member/about/work_education/index"); ?>
                                <?php $this->load->view("non_member/about/places/index"); ?>
                                <?php $this->load->view("non_member/about/contact_basic_info/index"); ?>
                                <?php $this->load->view("non_member/about/family_relationship/index"); ?>
                                <?php $this->load->view("non_member/about/details/index"); ?>
                            </div>
                        </div>
                    </div>
                </div>
