        ...
        <div class="col-md-4" ng-repeat="friend in friends">
            <div class="friend_list_img_style">
                <!--<a href='<?php // echo base_url(); ?>member/timeline/{{friend.userId}}' >-->
                    ...
                    <img fallback-src="<?php echo base_url() . PROFILE_PICTURE_PATH_W100_H100; ?>100x100_{{friend.genderId}}.jpg" alt="" src="<?php echo base_url() . PROFILE_PICTURE_PATH_W100_H100; ?>{{friend.userId}}.jpg" />
