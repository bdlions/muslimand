<div class="modal fade" id="modal_library_category_create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal_dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Create Library Category</h4>
            </div>
...
<script>
    function open_modal_library_category_create() {
        $('#modal_library_category_create').modal('show');
    }
</script>