<div class="modal fade" id="modal_video_category_update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal_dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Update Video Category</h4>
            </div>
...
<script>
    function open_modal_video_category_update() {
        $('#modal_video_category_update').modal('show');
    }
</script>