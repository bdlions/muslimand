<div class="modal fade" id="modal_page_category_create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
    function open_modal_page_category_create() {
        $('#modal_page_category_create').modal('show');
    }
</script>