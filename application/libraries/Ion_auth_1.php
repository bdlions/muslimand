...
class Ion_auth {
    ...
    public function registerTest($username, $password, $email, $additional_data = array(), $basic_info) { //need to test email activation
        $this->ion_auth_model->trigger_events('pre_account_creation');

        $email_activation = $this->config->item('email_activation', 'ion_auth');

        if (!$email_activation) {
            $result_event = $this->ion_auth_model->register($username, $password, $email, $additional_data, $basic_info);
