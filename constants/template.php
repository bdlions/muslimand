...
define('MEMBER_LOGGED_IN_TEMPLATE', 'templates/member_tmpl');
...
define('MEMBER_FUND_IN_TEMPLATE', 'templates/member_fund_tmpl');
define('MEMBER_LIBRARY_IN_TEMPLATE', 'templates/member_library_tmpl');
