<?php
     define("PAGE_ID_LENGTH",                                                  15);
     define("CATEGORY_TYPE_ID_FOR_BRAND",                                       "1");
     define("CATEGORY_TYPE_ID_FOR_PRODUCT",                                     "2");
     define("CATEGORY_TYPE_ID_FOR_GROUP",                                       "3");
     define("CATEGORY_TYPE_ID_FOR_COMMUNITY",                                   "4");
     define("CATEGORY_TYPE_ID_FOR_BUSINESS",                                    "5");
     define("CATEGORY_TYPE_ID_FOR_PLACE",                                       "6");
     define("CATEGORY_TYPE_ID_FOR_ENTERTAINMENT",                               "7");
     define("CATEGORY_TYPE_ID_FOR_COMPANY",                                     "8");
     define("CATEGORY_TYPE_ID_FOR_ORGANIZATION",                                "9");
     define("CATEGORY_TYPE_ID_FOR_INSTITUTION",                                 "10");
     define("CATEGORY_TYPE_ID_FOR_ARTIST_OR_BAND",                              "11");
     define("CATEGORY_TYPE_ID_FOR_PUBLIC_FIGURE",                               "12");
